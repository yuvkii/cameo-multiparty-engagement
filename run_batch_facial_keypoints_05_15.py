"""Batch facial keypoints extraction for 05_15 participant sessions.

Processes sessions 1-6 under Data/05_15/Processed/. Same flat layout as
03_25/05_14 -- no video/ subfolder, participants_rgb.avi sits directly
under Processed/<session>/ -- and no audio. All 6 sessions have footage.
"""
...
DATA_ROOT = Path(__file__).parent / "Data/05_15/Processed"
OUTPUT_ROOT = Path(__file__).parent / "outputs/05_15/facial_keypoints"
