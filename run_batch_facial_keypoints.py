"""Batch facial keypoints extraction for all participant sessions.

Processes sessions 1-6 under Data/03_20/Processed/, skipping any that lack
a participants_rgb.avi file (sessions 3 and 6).
"""
...
DATA_ROOT = Path(__file__).parent / "Data/03_20/Processed"
OUTPUT_ROOT = Path(__file__).parent / "outputs/facial_keypoints"

# Add the tool's src/ directory to sys.path so the package can be imported
