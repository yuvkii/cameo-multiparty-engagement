"""Batch facial keypoints extraction for 05_14 participant sessions.

Processes sessions 1-6 under Data/05_14/processed/, skipping any that lack
a participants_rgb.avi file (sessions 5-6 have no RGB footage yet). Same
layout as 03_25 -- no video/ subfolder, participants_rgb.avi sits directly
under processed/<session>/ -- and no audio.
"""
...
DATA_ROOT = Path(__file__).parent / "Data/05_14/processed"
OUTPUT_ROOT = Path(__file__).parent / "outputs/05_14/facial_keypoints"
