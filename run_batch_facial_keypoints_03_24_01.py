"""Batch facial keypoints extraction for 03_24_01 participant sessions.

Processes sessions 1-6 under Data/03_24_01/, skipping any that lack
...
DATA_ROOT = Path(__file__).parent / "Data/03_24_01"
OUTPUT_ROOT = Path(__file__).parent / "outputs/facial_keypoints_03_24_01"
