"""Batch facial keypoints extraction for 03_25 participant sessions.

Processes sessions 1-6 under Data/03_25/Processed/, skipping any that lack
a participants_rgb.avi file (sessions 4-6 have no footage for this date).
Unlike 03_20/03_24_01/03_24_02, this dataset has no video/ subfolder --
participants_rgb.avi sits directly under Processed/<session>/ -- and no
audio at all.
"""
...
DATA_ROOT = Path(__file__).parent / "Data/03_25/Processed"
OUTPUT_ROOT = Path(__file__).parent / "outputs/03_25/facial_keypoints"
...
def process_session(session_num: int) -> None:
    ...
    video_path = session_dir / "participants_rgb.avi"
